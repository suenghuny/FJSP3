...
def get_cfg():
    ...
    parser.add_argument("--hidden_size_obs", type=int, default=196, help="GTN 해당")
    parser.add_argument("--hidden_size_comm", type=int, default=108, help="")
    parser.add_argument("--n_representation_job", type=int, default=144, help="GTN 해당")
    ...
    parser.add_argument("--gamma", type=float, default=.95 , help="discount ratio")
